...
{% block content %}
    <div class="callout callout-info">
        <a class="btn btn-info btn-sm text-underline-none" href='/admin/project/edit/0'>
            <i class="fas fa-pencil-alt">&nbsp;</i>Thêm mới
        </a>

        <a class="btn btn-info btn-sm ml-5 text-underline-none" href='/admin/project/'>
